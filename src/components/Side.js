...
const overrides = {
	...
	"image": {
		...
		"props": {
			...
			"sm-left": "1.58em",
			"sm-top": "1.25em",
			"src": "https://uploads.quarkly.io/5fbbb8e92c4ef2001e329c56/images/logotype1200.png?v=2020-12-07T10:18:20.838Z"
		}
	},
	"box1": {
		"kind": "Box",
	...
	"Content": {
		"props": {
			"background": `
				url(https://uploads.quarkly.io/5fbbb8e92c4ef2001e329c56/images/Vector.svg?v=2020-11-23T13:55:51.651Z) top right/1.82em repeat-y,
	...
	"Button Open Line2 :open": {
		"props": {
			"sm-width": "1.56em",
			"sm-transform": "translateY(calc(-.1em - 2px)) rotate(135deg)"
		}
	},
	"Button Close": {
		"props": {
...
const Side = props => {
	...
	if (typeof window !== 'undefined') {
		isImageVisible = useMemo(() => {
			const {
				width,
				height
			} = window.screen;

			if (width < 1024 && width / height > 1.32) {
				isImageVisible = false;
			} else if (width / height > 2) {
				isImageVisible = false;
			}

			console.log(width, height, isImageVisible);
	...
	return <SideMenu {...rest}>
		...
		<Override slot="Content :closed" sm-display="none" />
		<Override slot="Content :open" sm-display="flex" />
		<Box {...override("box")}>
